...
MAX_EXPERTS = 6  # INCREASED to allow more preference clusters
...
LIKE_CLUSTERING_SIMILARITY_THRESHOLD = 0.6  # Similarity threshold for clustering liked watches
PURE_EXPLORATION_MODE = True  # Start in pure exploration until enough likes

# Dynamic expert creation settings - PREFERENCE-BASED
EXPERT_SIMILARITY_THRESHOLD = 0.7  # Increased for more distinct clusters
